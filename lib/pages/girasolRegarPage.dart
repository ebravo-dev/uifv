...
class RegarPage extends StatelessWidget {
  final AuxEstadoEvento estadoEvento;
  final Function refreshEvent;

  const RegarPage({Key key, this.estadoEvento, this.refreshEvent})
      : super(key: key);
          ...
          children: [
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: Image(
                  image:
                      AssetImage('assets/img/drop-of-water-2342870_1280.jpg'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'un cultivo de girasoles requiere un riego constante, aunque moderado, con mayor intensidad durante la etapa de crecimiento de la planta.',
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.black,
                      fontWeight: FontWeight.w400,
            ...
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(30),
                child: Image(
                  image: AssetImage('assets/img/plug-2342891_1280.jpg'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
